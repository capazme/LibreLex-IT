...
_PROCEDURE = (
    ...
    "già presenti (parti, importi, date, estremi) e per vedere quali partizioni dell'atto hai "
    "già inserito in un turno precedente: riprendi dalla prima mancante, senza ripetere quelle "
    "presenti; (3) se mancano campi obbligatori o dati necessari ai calcoli, chiedili all'utente "
    "in chat, tutti insieme e numerati, riepilogando prima in due righe il modello individuato e "
    "i dati già noti (così restano nella conversazione), e fermati senza scrivere nel documento; "
    "(4) quando i dati bastano, calcola gli importi con gli strumenti di "
